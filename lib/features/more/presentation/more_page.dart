...
class _MorePageState extends ConsumerState<MorePage>
  ...
  Widget build(BuildContext context) {
    ...
    final editionSection = _SettingsSection(
      title: 'Ciudad / Edición',
      child: Card(
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
                  ...
                  if (instanceOverridesEnabled) ...[
                    ...
                    Column(
                      children: [
                        OutlinedButton(
                          onPressed: () {
                            ref.read(editionYearProvider.notifier).decrement();
                          },
                        ...
                        OutlinedButton(
                          onPressed: () {
                            ref.read(editionYearProvider.notifier).increment();
                          },
    ...
    final testClockSection = _SettingsSection(
    ...
    final syncSection = _SettingsSection(
      title: 'Sincronización manual de datos',
      child: Card(
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
              ...
              children: [
                if (isTablet) ...[
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Expanded(child: apiSection),
                      const SizedBox(width: 16),
                      Expanded(child: editionSection),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 16),
                      Expanded(child: testClockSection),
                    ],
                  ),
                  const SizedBox(height: 20),
                  syncSection,
